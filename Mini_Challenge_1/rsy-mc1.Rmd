...
### Vergleich Cosine Similiarty mit Recommenderlab

```{r}
recom_simcosin_4 <- similarity(normalize(MovieLense[1:number_user, 1:number_item]))
...
result_cossim_4_scaled
```


### Vergleich Cosine Similiarity mit anderem R-Paket
