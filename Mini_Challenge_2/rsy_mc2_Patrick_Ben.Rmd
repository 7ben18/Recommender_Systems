...
as(rr_Movie_genre_matrix, "data.frame")
```


```{r}
cosine_sim_user_genre_movie_genre <- similarity(x = rr_user_genre_matrix, y = Movie_Genre_df[2:20], method = "cosine", which = "items")
