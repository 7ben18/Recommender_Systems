...
user_genre_rowsums <- rowSums(test_user_genre_matrix, na.rm = T)
movie_genre_rowsums <- rowSums(test_movie_genre_matrix, na.rm = T)
...
cosine_sim_func <- function(user_genre_matrix, movie_genre_matrix){
  ...
  user_genre_sqrt_rowsum_x2 <- rowSums(user_genre_matrix, na.rm = T)
  movie_genre_sqrt_rowsum_x2 <- rowSums(movie_genre_matrix, na.rm = T)
